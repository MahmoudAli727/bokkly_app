...
class BookDetailsListbloc extends StatefulWidget {
  const BookDetailsListbloc({super.key});

  @override
  State<BookDetailsListbloc> createState() => _BookDetailsListblocState();
}

class _BookDetailsListblocState extends State<BookDetailsListbloc> {
    ...
    return BlocConsumer<FeaturedBookDCubit, FeaturedBookDState>(
      ...
      builder: (context, state) {
        if (state is FeaturedBook_DSuccess ||
          ...
          return FeatureList(books: books);
